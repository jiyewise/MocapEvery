...
class MotionFilter:
    ...
    def track(self, tstamp, image, depth=None, intrinsics=None):
        ...
        inputs = inputs.sub_(self.MEAN).div_(self.STDV) # torch.Size([1, 1, 3, 328, 584])

        # extract features
        gmap = self.__feature_encoder(inputs) # [1, 128, ht, wd]
        self.gmap_list.append(gmap.clone().detach().cpu().numpy())
